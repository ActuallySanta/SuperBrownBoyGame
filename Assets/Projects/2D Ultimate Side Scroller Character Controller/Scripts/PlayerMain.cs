...
namespace UltimateCC
{
    public class PlayerMain : MonoBehaviour
    {
        ...
        [NonSerialized] public CapsuleCollider2D CapsuleCol; // CapsuleCollider2D is used to handle slopes and define the ground check position in the base state class: "State.cs".
