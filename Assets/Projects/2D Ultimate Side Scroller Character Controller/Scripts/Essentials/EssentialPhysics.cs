...
namespace UltimateCC
{
    public static class EssentialPhysics
    {
        ...
        public static void GroundCheck(PlayerMain player, PlayerData playerData)
        {
            ...
            float _offset = -0.01f;
            RaycastHit2D _hit = Physics2D.CircleCast(playerData.Physics.GroundCheckPosition, player.CapsuleCol.size.x / 2 * Mathf.Abs(player.transform.localScale.x) + _offset, -player.transform.up, 0.2f, playerData.Physics.GroundLayerMask);
        ...
        public static Vector2 SetGroundCheckPosition(PlayerMain player, PlayerData playerData)
        {
            ...
            Vector2 _size = new(player.CapsuleCol.size.x * Mathf.Abs(player.transform.localScale.x), player.CapsuleCol.size.y * player.transform.localScale.y);
            Vector2 _offset = new(player.CapsuleCol.offset.x * Mathf.Abs(player.transform.localScale.x), player.CapsuleCol.offset.y * player.transform.localScale.y);
            ...
            _groundCheckPosition = _groundCheckPosition.RotateAround((Vector2)player.transform.position + player.CapsuleCol.offset, player.Rigidbody2D.rotation);
        ...
        public static Vector2 SetHeadCheckPosition(PlayerMain player, PlayerData playerData)
        {
            ...
            _headCheckPosition = _headCheckPosition.RotateAround((Vector2)player.transform.position + player.CapsuleCol.offset, player.Rigidbody2D.rotation);
        ...
        public static bool MultipleGroundContactCheck(PlayerMain player, PlayerData playerData)
        {
            ...
            float _offset = -0.01f;
            RaycastHit2D _frontHit = Physics2D.CircleCast(playerData.Physics.GroundCheckPosition, player.CapsuleCol.size.x / 2 * Mathf.Abs(player.transform.localScale.x) + _offset, playerData.Physics.FacingDirection * Vector2.right, 0.1f, playerData.Physics.GroundLayerMask);
        ...
        public static void WallCheck(PlayerMain player, PlayerData playerData)
        {
            ...
            float _offset = 0.1f;
            RaycastHit2D _rightHit = Physics2D.Raycast(playerData.Physics.HeadCheckPosition, Vector2.right, player.CapsuleCol.size.x / 2 * Mathf.Abs(player.transform.localScale.x) + _offset, playerData.Physics.WallLayerMask);
            RaycastHit2D _leftHit = Physics2D.Raycast(playerData.Physics.HeadCheckPosition, Vector2.left, player.CapsuleCol.size.x / 2 * Mathf.Abs(player.transform.localScale.x) + _offset, playerData.Physics.WallLayerMask);
        ...
        public static void HeadBumpCheck(PlayerMain player, PlayerData playerData)
        {
            ...
            RaycastHit2D _hit;
            float _offset = 0.01f;
            _hit = Physics2D.CircleCast(playerData.Physics.HeadCheckPosition, player.CapsuleCol.size.x / 2 * Mathf.Abs(player.transform.localScale.x) + _offset, player.transform.up, 0.2f, playerData.Physics.HeadBumpLayerMask);
            if (_hit)
            {
